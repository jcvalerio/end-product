...
export function ReadOnlyTextWidget({ params, taskName, widgetId }: WidgetProps): ReactElement {
  ...
  return (
    <div className={classes.widgetContent}>
      <ReadOnlyText context={widgetData} params={params} widgetId={widgetId}></ReadOnlyText>
    </div>
  );
}
